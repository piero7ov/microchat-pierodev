...
<head>
  <meta charset="utf-8">
  <title>Microchat (UI clara)</title>
  ...
  <div class="wrap">
    ...
    <div class="chat">
      <?php if ($userMsg === "" && $assistant === ""): ?>
        <div class="bubble assistant">
          ...
          Hola 👋 Escribe un mensaje abajo y te respondo con tu IA local (Ollama).
        </div>
      <?php endif; ?>
    ...
    <form method="post">
      <div style="flex:1;">
        ...
        <div class="hint">Tip: si quieres probar, escribe: “Dame 3 ideas de proyectos en PHP”.</div>
      </div>
      <div class="right">
